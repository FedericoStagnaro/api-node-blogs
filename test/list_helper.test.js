...
describe('total likes', () => {
  test('total likes from all post', () => {
    const blogs = [
      { likes: 5 },
      { likes: 10 },
      { likes: 15 }
  ...
  test('total likes from one post', () => {
...
describe('favorite blogs', () => {
  test('favorite for 0 blogs', () => {
    const blogs = []
    expect(listHelper.favoriteBlog(blogs)).toEqual(null)
  })

  test('favorite for 1 blogs', () => {
    const expected =
    {
...
describe('Most Liked author', () => {
  ...
  test('for 1 blogs', () => {
    ...
    expect(listHelper.mostLikes(blogs)).toEqual({ author: 'Robert C. Martin', likes: 2 })
  })
})
